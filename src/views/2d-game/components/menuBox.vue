<template>
    <div class="menu-box text-center px-9px py-6px">
        <div class="text-14px ml-5px mr-5px mt-10px pb-5px border-b-1px border-b-solid border-b-#677386"
            @click.stop="showDescriptionPop = true">{{ $t("2d-game.description")}} <br /> {{ $t("2d-game.lottery") }} </div>
        <div class="py-9px text-12px mt-5px mb-10px" @click.stop="showTodayBetPop = true">{{ $t("2d-game.bet-today") }}</div>
    </div>
