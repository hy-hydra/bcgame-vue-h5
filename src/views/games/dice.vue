  ...
  <div class="game-page">
    ...
    <div class="game-tool">
      ...
      <div v-if="activeTab === 'manual'" class="win-amount">
        ...
        <div class="on-stopwin-content">
          <div class="on-stopwin-input">
            ...
            <img src="@/assets/coin/JPY.webp" class="coin" width="16">
          </div>
        </div>
      </div>
      <div v-if="activeTab === 'auto'" class="betting-box">
        <div>
          ...
          <div class="input-control">
            ...
            <div class="amount-btn">
              <button class="amount-customize" @click="changeBetsNumber('∞')">∞</button>
              <button class="amount-customize" @click="changeBetsNumber('10')">10</button>
              <button class="amount-customize" @click="changeBetsNumber('100')">100</button>
            </div>
          </div>
        </div>
        <div class="on-win">
          ...
          <div class="on-win-content">
            <div class="winTabs">
              <button :class="{ active: activeWinTab === 'reset' }" @click="changeWinTab('reset')">Reset</button>
              <button :class="{ active: activeWinTab === 'increase' }" @click="changeWinTab('increase')"> Increase
                by</button>
            </div>
        ...
        <div class="on-win">
          ...
          <div class="on-win-content">
            <div class="winTabs">
              <button :class="{ active: activeLoseTab === 'reset' }" @click="changeLoseTab('reset')">Reset</button>
              <button :class="{ active: activeLoseTab === 'increase' }" @click="changeLoseTab('increase')"> Increase
                by</button>
            </div>
            <div class="on-win-input">
              <input type="text" />
      ...
      <div class="help-box">
        ...
        <p class="script-tips">
          Use of scriptis optional and players must take full responsibiity for any attendant risks. We will not be held
          liable in this regard.
        </p>
      </div>
      <div class="mode-tab">
        <button :class="{ active: activeTab === 'manual' }" @click="changeTab('manual')">Manual</button>
        <button :class="{ active: activeTab === 'auto' }" @click="changeTab('auto')">Auto</button>
      </div>
    </div>
