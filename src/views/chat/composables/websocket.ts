...
let globalCallback: any = function() {};
...
function initWebSocket() {
  ...
  var ws = `${process.env.VITE_APP_WS_URL}ws?device=${user_device}&domain=${process.env.VITE_APP_HOSTNAME? process.env.VITE_APP_HOSTNAME: window.location.hostname}`;
  // websock = new WebSocket(ws, [access_token])
